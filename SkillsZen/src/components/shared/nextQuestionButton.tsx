...
const ContinueButton: React.FC<ContinueButtonProps> = ({ onClick, disabled }) => {
  ...
  return (
    <Button
      disabled={disabled}
      style={disabled ? {
        cursor: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' viewBox='0 0 24 24' fill='none' stroke='red' stroke-width='3' stroke-linecap='round' stroke-linejoin='round'><circle cx='12' cy='12' r='9'/><line x1='5.5' y1='18.5' x2='18.5' y2='5.5'/></svg>\") 12 12, not-allowed"
      } : {}}
