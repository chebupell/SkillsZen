        ...
        <div className="mt-6 mb-4 flex flex-col items-center text-center space-y-8 animate-in fade-in duration-1000 delay-500">
          ...
          <div className="max-w-2xl space-y-4">
            ...
            <p className="text-sm text-slate-500 leading-relaxed font-medium italic">
              "True growth is a quiet dialogue with your own potential. Complexity is simply layers
              of simplicity that haven't been unraveled yet. Take your time. Breathe. Clarity comes
              to the <span className="text-primary font-bold not-italic">focused mind</span>."
            </p>
          </div>
